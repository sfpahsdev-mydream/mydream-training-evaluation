...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument(
        "--experiment-set",
        choices=["packaged", "large", "advanced", "all"],
        default="packaged",
...
def selected_experiments(name: str) -> tuple[Experiment, ...]:
    ...
    if name == "advanced":
        return (PACKAGED_EXPERIMENTS[0],) + ADVANCED_EXPERIMENTS
    return PACKAGED_EXPERIMENTS + LARGE_CAPACITY_EXPERIMENTS + ADVANCED_EXPERIMENTS
